            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item">
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/clientes/ADESU-min.jpg" style="width: 120px; height: 120px;" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/clientes/AEROSUR-min.jpg" style="width: 120px; height: 120px;" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/clientes/ALTO-LTDA-min.jpg" style="width: 120px; height: 120px;" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/clientes/american-business.jpg" style="width: 120px; height: 120px;" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/clientes/american-business-1.jpg" style="width: 120px; height: 120px;" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/clientes/ASTON2.jpg" style="width: 120px; height: 120px;" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/clientes/CNG-min.jpg" style="width: 120px; height: 120px;" alt="">
                    </div>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center pt-3">
                        <img class="img-fluid rounded-circle" src="img/clientes/COFADENA-min.jpg" style="width: 120px; height: 120px;" alt="">
                    </div>
                </div>
            </div>
        </div>
