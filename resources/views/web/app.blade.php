...
<body>
    ...
    <div class="container-fluid bg-secondary text-white pt-5 px-sm-3 px-md-5" style="margin-top: 90px;">
        <div class="row pt-5">
            ...
            <div class="col-lg-4 col-md-6 mb-5">
                <h4 class="font-weight-semi-bold text-primary mb-4">Boletín Informativo</h4>
                <p>Reciba actualizaciones legales, novedades y consejos profesionales directamente en su correo.</p>
                <div class="w-100">
        ...
        <div class="row p-4 mt-5 mx-0" style="background: rgba(256, 256, 256, .05);">
            <div class="col-md-6 text-center text-md-left mb-3 mb-md-0">
                <p class="m-0 text-white">&copy; <a class="font-weight-bold" href="https://arandalegal.com/" target="_blank">Aranda y Asociados</a>. Todos los derechos reservados.</p>
            </div>
